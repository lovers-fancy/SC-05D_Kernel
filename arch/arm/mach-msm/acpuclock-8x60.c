...
#define MAX_RUN_KHZ         1620000 /* KHz */
...
static struct clkctl_l2_speed l2_freq_tbl_v2[] = {
	...
	[20] = {1512000,  1, 0x1C, 1200000, 1250000, 5},
};

#define L2(x) (&l2_freq_tbl_v2[(x)])

/* SCPLL frequencies = 2 * 27 MHz * L_VAL */
static struct clkctl_acpu_speed acpu_freq_tbl_default[] = {
...
static __init struct clkctl_acpu_speed *select_freq_plan(void)
{
	...
	if (speed_bin == 0x2) {
		...
		case 0x1:
		case 0x3:
			acpu_freq_tbl = acpu_freq_tbl_default;
			pr_info("ACPU PVS: Default\n");
			break;
		default:
			acpu_freq_tbl = acpu_freq_tbl_default;
			pr_info("ACPU PVS: Default\n");
