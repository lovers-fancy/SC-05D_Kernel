/*
 *  drivers/cpufreq/cpufreq_dads.c
 *
...
#define DEF_FREQUENCY_UP_THRESHOLD_HOTPLUG	(50)
...
/* cpufreq_dads Governor Tunables */
...
#ifndef CONFIG_CPU_FREQ_DEFAULT_GOV_DADS
static
#endif
struct cpufreq_governor cpufreq_gov_dads = {
	.name			= "dads",
...
{
	return cpufreq_register_governor(&cpufreq_gov_dads);
}

static void __exit cpufreq_gov_dbs_exit(void)
{
	cpufreq_unregister_governor(&cpufreq_gov_dads);
}


MODULE_AUTHOR("PaPa <lovers.fancy@gmail.com>");
MODULE_DESCRIPTION("'cpufreq_dads' - A dynamic cpufreq governor for "
		"Low Latency Frequency Transition capable processors "
		"optimised for use in a battery environment");
MODULE_LICENSE("GPL");

#ifdef CONFIG_CPU_FREQ_DEFAULT_GOV_DADS
